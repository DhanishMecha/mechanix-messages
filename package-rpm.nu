...
# RPM Packaging Script for Mechanix Messages
# Usage: nu package-rpm.nu messages <output-dir>

# Copied from mechanix-calc/package-rpm.nu to ensure consistent packaging behavior
